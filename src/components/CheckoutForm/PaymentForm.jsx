    ...
    const handleSubmit = async (event, elements, stripe) => {
        ...
        if(error){
            ...
            const orderData = {
                ...
                shipping: { name: 'España', street: shippingData.address1, town_city: shippingData.city, county_state: shippingData.shippingSubdivision, postal_zip_code: shippingData.zip, country: shippingData.shippingCountry },
